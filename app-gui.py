...
class PageTwo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.dropdown = tk.OptionMenu(self, self.menuvar, *names, command=self.update_user_name)
    ...
    def update_user_name(self, selected_name):
        self.user_name.delete(0, 'end')
        self.user_name.insert(0, selected_name)
