...
def main_app(name):
        ...
        face_cascade = cv2.CascadeClassifier('C:/Users/tanzeel/AppData/Local/Programs/Python/Python313/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml')
